...
export class CommentsService {
  ...
  getCommentsByID(CommentID, ProfileID) {
    return this.http.get(`${Api_Url}/api/Comment?CommentID=${CommentID}&ProfileID=${ProfileID}`, { headers: this.getHeaders() });
  }
